angular.module('ApiModule', [])
    .factory('apiService', ['$http', '$rootScope', '$state', '$q', '$resource', 'configurationService', 'localStore', 'localStoreConstants',
        function ($http, $rootScope, $state, $q, $resource, configurationService, localStore, localStoreConstants) {
            'use strict';
